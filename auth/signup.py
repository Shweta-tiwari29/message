...
def signup(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # Define the user schema with messaging-related fields
        user_data = {
            'email': email,
            'username': username,
            ...
            'chats': [],  # List of chat/group chat IDs
            'online_status': 'offline',  # Default to offline
            'last_seen': None,  # Will be updated when user logs in
        }
        ...
        response_data = {
            ...
            'user': {
                ...
                'chats': [],  # Initialize empty chats list
                'online_status': 'offline',  # User starts offline
                'last_seen': None
            }
        }
